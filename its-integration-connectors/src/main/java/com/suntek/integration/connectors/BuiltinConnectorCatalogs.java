...
public final class BuiltinConnectorCatalogs {
    ...
    private static java.util.List<ConnectorSpec> scanAll() {
        return java.util.List.of(
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.demo.DemoNoneConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.demo.DemoAkskConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.idps.IdpsConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.gaode.GaodeOpenPlatformConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.gaode.GaodeTrafficConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.baidu.BaiduMapConnectorCatalog.class),
                com.suntek.integration.spec.catalog.CatalogConnectorScanner.scan(
                        com.suntek.integration.connectors.baidu.BaiduWenxinConnectorCatalog.class));
    }
}
