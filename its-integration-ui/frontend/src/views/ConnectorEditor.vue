...
<template>
  <section class="panel">
    <div class="toolbar">
      ...
      <span v-if="catalogManaged" class="badge" title="端点由 Java Catalog 维护">Catalog</span>
    </div>
    <p v-if="catalogManaged" class="hint">
      内置 Catalog 连接器：仅可修改 Base URL 与凭证；端点/认证/响应请在
      <code>its-integration-connectors</code> 中改代码后重启。
    </p>
