 ...
 */
package com.suntek.apiconnector.api.controller;

import com.suntek.apiconnector.api.dto.ConnectorEndpointSummary;
...
import com.suntek.apiconnector.api.openapi.EndpointOpenApiMetadataResolver;
...
import com.suntek.apiconnector.api.invoke.ServletStreamingInvocationSink;
...
public class IntegrationProxyController {
    ...
    @ApiResponse(responseCode = "404", description = "未知连接器",
            content = @Content(schema = @Schema(implementation = com.suntek.apiconnector.api.dto.ApiErrorResponse.class)))
